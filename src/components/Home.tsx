...
export default function Home({ appInfo, savedTitle, onOpen, onOpenFdx, onOpenProject, importError, importing, onShowFoundation }: HomeProps) {
  return (
    <div className="home">
      ...
      <div className="home-actions">
        <button className="home-action primary" onClick={onOpenFdx} disabled={importing}>
          ...
          <span className="home-action-desc">Import and edit a local Final Draft screenplay.</span>
        </button>
        ...
        <button className="home-action" onClick={onOpenProject} disabled={importing}>
